...
<head>
    ...
    <title>Profession - Employee Login</title>
</head>
...
<div class="page-wrapper">
    ...
    <div class="main-wrapper">
        <div class="main">
            <div class="document-title">
                <div class="container">
                    <h1 class="center">Labour Login</h1>
                </div><!-- /.container -->
            </div><!-- /.document-title -->
	...
	<div class="row">
		<div class="col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4">
			<form method="post" action="personal_login_success.php">
				<div class="form-group">
					<label for="form-login-username">Username</label>
					<input type="text" class="form-control" id="form-login-username" name="form-login-username">
				</div><!-- /.form-group -->
...
<!-- Mirrored from preview.byaviators.com/template/profession/login.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 19 Aug 2018 11:09:11 GMT -->
                </html>
